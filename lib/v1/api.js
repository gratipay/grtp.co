(function(_) {
    ...
    Gratipay.widgets = {
        ...
        load: function(element) {
            ...
            element.setAttribute('data-gratipay-readystatus', 'loading api.js step 1');
            ...
            Gratipay.widgets.getWidget(widgetType, function(widget) {
                ...
                element.setAttribute('data-gratipay-readystatus', 'loading api.js step 2');
                ...
                element.setAttribute('data-gratipay-readystatus', 'loading api.js step 3');
                ...
                if (username in locals()) {
                    widget.setAttribute('data-gratipay-username', username);
                        element.setAttribute('data-gratipay-readystatus', 'loading api.js step 4');
                } else if (slug in locals()) {
                    widget.setAttribute('data-gratipay-username', slug);
                        element.setAttribute('data-gratipay-readystatus', 'loading api.js step 5');
                }
