(function(_) {
    ...
    window.Gratipay = window.Gratipay || {};
    ...
    Gratipay.widgets = {
        ...
        apply: function(element, cb) {
            ...
            function set(className, property, value, attribute, append) {
                var legacy_elements_array = Array.prototype.slice.call(element.getElementsByClassName('gittip-' + className));
                var elements_array = Array.prototype.slice.call(element.getElementsByClassName('gratipay-' + className));
                _.each(elements_array.concat(legacy_elements_array), function(element) {
                    if (attribute)
            ...
            Gratipay.users.getPublic(username, function(data) {
                ...
                text('my-tip-button', data.my_tip == 'self' ? 'You!' : (+data.my_tip > 0 ? data.my_tip : 'Gratipay'));
                text('goal', '$' + data.goal);
