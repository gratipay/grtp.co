(function(_) {
    ...
    var gratipayURI = window.gratipayURI || 'https://www.gratipay.com/';
    ...
    Gratipay.widgets = {
        ...
        apply: function(element, cb) {
            var username = element.getAttribute('data-gratipay-username');

            function set(className, property, value, attribute, append) {
                _.each(element.getElementsByClassName('gratipay-' + className), function(element) {
                    if (attribute)
        ...
        load: function(element) {
            var widgetType = element.getAttribute('data-gratipay-widget') || 'default',
                    username     = element.getAttribute('data-gratipay-username');
