    ...
    Gratipay.widgets = {
        ...
        load: function(element) {
            ...
            Gratipay.widgets.getWidget(widgetType, function(widget) {
                ...
                function onload() {
                    // Resize the container <iframe> to fit the content, and
                    // fall back to resizing on an interval if MutationObserver
                    // does not exist
                    if (typeof MutationObserver !== 'undefined' && false) {
                        new MutationObserver(resize)
                            .observe(container.contentDocument.body, {
                                subtree: true,
                                attributes: true,
                                childList: true,
                                characterData: true
