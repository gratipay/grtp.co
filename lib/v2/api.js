(function(_) {
    ...
    Gratipay.widgets = {
        ...
        apply: function(element, cb) {
            var teamslug = element.getAttribute('data-gratipay-teamslug');
            ...
            // Set up links and team slug before requesting public.json
            link('profile-link', gratipayURI + encodeURIComponent(teamslug) + '/');
            link('link', gratipayURI);
            text('slug', teamslug);
            text('identity', 'We');

            Gratipay.users.getPublic(teamslug, function(data) {
              ...
              //  text('receiving', (data.receiving)? '$' + parseFloat(data.receiving).toFixed(2) : '$' + parseFloat(data.receiving).toFixed(2));
        ...
        load: function(element) {
            ...
            Gratipay.widgets.getWidget(widgetType, function(widget) {
                ...
                widget.setAttribute('data-gratipay-teamslug', teamslug);
